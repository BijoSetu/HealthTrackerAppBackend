...
val mileStoneFixtures = arrayListOf(
    Milestone(
        id = 1,
        userId = 1,
        milestoneName = "Walked 100,000 Steps",
    ...
    Milestone(
        id = 2,
        userId = 1,
        milestoneName = "Completed 30-Day Yoga Challenge",
    ...
    Milestone(
        id = 3,
        userId = 1,
        milestoneName = "Lost 5 Kg in 3 Months",
    ...
    Milestone(
        id = 4,
        userId = 1,
        milestoneName = "Ran a Half Marathon",
    ...
    Milestone(
        id = 5,
        userId = 1,
        milestoneName = "Read 20 Books in a Year",
